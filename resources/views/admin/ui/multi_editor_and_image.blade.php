<div class="form-group row">
    ...
    <div class="col-md-12">
        <div class="multi-item-container">
            ...
            @foreach ($model->$fieldModelName ?: json_decode('[{"text":"","image":""}]') as $key => $value)
                <div class="multi-item row mb-2">
                    <div class="col-md-6">
                        <textarea
                                id="ckeditor{{ str_slug($fieldName . $key) }}"
                                class="ckeditor multi-item-element form-control"
                                data-key="text"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="mt-2 img-preview" data-preview-id="{{ str_slug($fieldName . $key) }}"></div>
                    </div>
