<div class="item-product item-product4 text-center border">
    ...
    <div class="product-info">
        ...
        <div class="product-extra-link4 title18">
            <a href="#" class="wishlist-link black inline-block"><i class="icon {{ $model->isLiked() ? 'ion-ios-cart' : 'ion-ios-cart-outline' }}" data-slug="{{$model->slug}}"></i><span class="title10 white text-uppercase">{{ $model->isLiked() ? 'Удалить из корзины' : 'Добавить в корзину' }}</span></a>
        </div>
    </div>
</div>