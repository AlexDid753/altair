        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="header_year white">2018</div>
                    <!-- End logo -->
                    ...
                    <ul class="wrap-cart-top2 list-inline-block pull-right">
                        <li>
                            <a href="#" class="title18 wishlist-link" title="Избранное"><span class="white"><i class="icon ion-android-favorite-outline"></i></span><sup class="title10 round dark bg-white">{{count(\App\Product::liked())}}</sup></a>
                        </li>
                    </ul>
                </div>
            </div>
